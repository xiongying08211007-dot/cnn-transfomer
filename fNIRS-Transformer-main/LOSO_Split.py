...
def Split_Dataset_A_Res(sub, feature, label, channels):
    """
    Split one subject's c_preT_data to evaluate the results of LOSO-CV on Dataset A.
...
def Split_Dataset_B_Res(sub, feature, label, channels):
    """
    Split one subject's c_preT_data to evaluate the results of LOSO-CV on Dataset B.
...
def Split_Dataset_C_Res(sub, feature, label, channels):
    """
    Split one subject's c_preT_data to evaluate the results of LOSO-CV on Dataset C.
